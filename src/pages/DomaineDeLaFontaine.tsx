...
import { 
  Camera, Utensils, Flower2, Music, Heart, Gem, Check, ArrowRight, 
  Phone, Mail, FileText, ClipboardList, Armchair, Instagram, 
  Calendar, MapPin, Users, Clock, CreditCard, ChevronDown
} from 'lucide-react';
...
const documents = [
  ...
  },
  {
    ...
    url: "https://instagram.com/domainedelafontaine", // Placeholder
    type: "link"
  }
];
...
const DomaineDeLaFontaine = () => {
  ...
  return (
    <>
      <SEO 
        title="Guide d'accueil - Domaine de la Fontaine | Mariable" 
        description="Votre guide personnalisé pour préparer sereinement votre mariage au Domaine de la Fontaine. Partenaires, documents et informations pratiques." 
      />
          ...
          <div className="space-y-4">
            {partners.map((partner, index) => (
              <motion.div
                ...
                className="bg-editorial-beige/20 border border-editorial-noir/5 p-5"
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                  ...
                  <div className="flex flex-wrap gap-4 ml-14 md:ml-0">
                    <a 
                      ...
                      className="flex items-center gap-2 text-sm text-editorial-noir/60 hover:text-editorial-noir transition-colors"
                    >
        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <a 
                href="mailto:contact@domainefontaine.fr"
                className="flex items-center gap-2 px-4 py-2 bg-editorial-beige text-editorial-noir text-sm hover:bg-editorial-beige/70 transition-colors"
              >
                <Mail className="h-4 w-4" />
        ...
        <div className="container mx-auto px-4 max-w-2xl text-center">
          ...
          >
            ...
            <p className="text-editorial-noir/60 mb-8">
              Organisez votre mariage sereinement avec nos outils gratuits
            </p>
