          ...
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <div className="flex flex-wrap justify-center gap-4">
                <Button asChild className="bg-wedding-olive hover:bg-wedding-olive/90"><Link to="/professionnelsmariable?region=bourgogne-franche-comte"><MapPin className="mr-2 h-4 w-4" />Voir les prestataires</Link></Button>
              </div>
            </div>
          </div>
        </section>
