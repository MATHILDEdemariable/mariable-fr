        ...
        <section className="py-16 md:py-20 bg-wedding-olive text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            fontFamily: 'Playfair Display, serif'
              ...
              Prêt à profiter pleinement de votre mariage ?
            </h2>
            <p className="text-lg opacity-90 mb-8 max-w-3xl mx-auto">
              Rejoignez des milliers de couples qui ont choisi Mariable pour organiser leur mariage en toute simplicité.
            </p>
            <Button asChild size="lg" className="bg-white text-wedding-olive hover:bg-gray-100">
              <Link to="/register">
                Créer mon compte gratuit <ArrowRight className="ml-2 h-5 w-5" />
              </Link>
            </Button>
