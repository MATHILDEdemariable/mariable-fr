        ...
        <section className="bg-gradient-to-br from-wedding-cream/50 to-wedding-olive/10 py-16">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto text-center">
              ...
              <Button asChild className="bg-wedding-olive hover:bg-wedding-olive/90"><Link to="/selection?region=corse"><MapPin className="mr-2 h-4 w-4" />Voir les prestataires</Link></Button>
            </div>
          </div>
        </section>
