                ...
                <Card className="border-2 border-slate-200 hover:border-editorial-beige/40 transition-all duration-500 hover:shadow-xl rounded-none">
                  <CardContent className="p-8">
                    <div className="flex items-center gap-3 mb-6">
                      ...
                      <h3 className="text-xl font-serif text-foreground">Le problème des prestataires & marques</h3>
                    </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto mb-12">
              {[
                ...
                >
                  <Card className="text-center border-2 hover:border-editorial-beige/40 transition-all duration-500 hover:shadow-xl hover:-translate-y-2 group h-full rounded-none">
                    <CardContent className="p-8">
                      <div className="text-6xl mb-6 group-hover:scale-110 transition-transform duration-300">{step.icon}</div>
                      <div className="inline-flex items-center justify-center w-10 h-10 bg-editorial-noir text-white font-bold mb-4 text-lg shadow-lg">
                        {step.num}
                      </div>
                      <h3 className="font-serif text-foreground mb-2 text-lg">{step.title}</h3>
            ...
            <Card className="max-w-2xl mx-auto border-2 border-editorial-beige/30 bg-gradient-to-br from-editorial-beige/30 to-transparent rounded-none">
              <CardContent className="p-8">
                <h4 className="font-serif text-foreground mb-6 text-center text-xl">💰 Structure de coûts</h4>
                <div className="space-y-4">
                  <div className="bg-white/80 p-4 rounded-xl">
                    ...
                    <ul className="ml-4 space-y-2 text-muted-foreground">
                      <li className="flex items-center gap-2"><span className="w-2 h-2 rounded-full bg-editorial-noir" /> Un avantage couple (réduction ou autre avantage si marge trop réduite)</li>
                ...
                <div className="mt-6 text-center">
                  <Button 
                    variant="outline"
                    onClick={() => navigate('/contact')}
                    className="border-editorial-noir text-editorial-noir hover:bg-editorial-beige rounded-none"
                  >
