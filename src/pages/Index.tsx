        ...
        <section className="py-16 md:py-20 bg-white">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 style={{
              fontFamily: 'Playfair Display, serif'
            }} className="sm:text-3xl md:text-4xl font-serif text-black mb-6 max-w-4xl mx-auto text-3xl font-medium">Simple, effi grâce à notre wedding planner en ligne </h2>
