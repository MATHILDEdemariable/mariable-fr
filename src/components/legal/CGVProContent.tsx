...
/**
 * Contenu des conditions professionnelles réutilisé par la page dédiée et par la modale d'inscription.
 * Aucune logique : uniquement le texte légal.
 */
