...
const ProjectManagement: React.FC = () => {
    ...
    const checkAuth = async () => {
      try {
        ...
        if (!data.session) {
          toast({
            title: "Non connecté",
            description: "Vous devez être connecté pour accéder à Mission Mariage",
            variant: "destructive"
          });
  ...
  return (
    <ErrorBoundary>
      <Helmet>
        <title>Mission Mariage | Mariable</title>
        <meta name="description" content="Gérez et organisez la préparation de votre mariage" />
      </Helmet>
