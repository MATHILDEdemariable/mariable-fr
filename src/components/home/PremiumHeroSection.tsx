      ...
      <div className="relative z-20 text-center max-w-6xl mx-auto px-4">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          <Button
            ...
            className="bg-gradient-to-r from-premium-gradient-start via-premium-gradient-mid to-premium-gradient-end text-white hover:opacity-90 transition-all duration-300 hover:scale-105 px-8 py-4 text-lg font-semibold"
          >
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-8 text-white/80 text-sm font-medium">
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-premium-gradient-start rounded-full"></div>
            <span>98% satisfaction</span>
          </div>
          <div className="hidden sm:block w-px h-4 bg-white/30"></div>
          <div className="flex items-center gap-2">
            <div className="w-2 h-2 bg-premium-gradient-mid rounded-full"></div>
