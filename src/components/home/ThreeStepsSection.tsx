      ...
      <section id="three-steps-section" className="py-16 md:py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif text-black mb-4">Arrivez à votre mariage comme un invité </h2>
                ...
                <div className="flex-grow">
                  ...
                  <ul className="space-y-3 mb-6">
                    <li className="flex items-center gap-3">
                      ...
                      <span className="text-gray-700">Séléction premium</span>
                    </li>
                    <li className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-wedding-olive" />
                    ...
                    <li className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-wedding-olive" />
                      <span className="text-gray-700">Professionnels d'excellence et de confiance triés sur le volet</span>
                    </li>
                  </ul>
                </div>
                
                <Button onClick={() => setIsCarnetModalOpen(true)} className="w-full bg-wedding-olive hover:bg-wedding-olive/90 text-white group-hover:scale-105 transition-all mt-auto">
                  Recevoir le carnet
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="group hover:shadow-xl transition-all duration-300 hover:-translate-y-2 bg-white border-0 shadow-lg">
              <CardContent className="p-8 flex flex-col h-full min-h-[400px]">
                <div className="flex-grow">
                  ...
                  <h3 className="text-xl font-semibold mb-6 text-gray-800">avec une appli. </h3>
                  ...
                  <ul className="space-y-3 mb-6">
                    ...
                    <li className="flex items-center gap-3">
                      <Check className="w-5 h-5 text-wedding-olive" />
                      <span className="text-gray-700">Accessible sans téléchargement, compatible ordinateurs, tablettes, mobiles</span>
                    </li>
                  </ul>
                </div>
