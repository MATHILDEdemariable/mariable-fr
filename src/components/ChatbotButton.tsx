          ...
          <Card className="absolute bottom-0 right-0 w-[350px] md:w-[400px] h-[500px] shadow-2xl rounded-xl overflow-hidden border">
            <div className="h-full flex flex-col">
              <div className="bg-wedding-olive p-3 flex justify-between items-center text-white">
                ...
                <Button variant="ghost" size="icon" className="text-white hover:bg-wedding-olive/80" onClick={toggleChat}>
                  <X size={18} />
                </Button>
              </div>
              <div className="flex-grow overflow-hidden">
                <ChatInterface isSimpleInput={false} initialMessage="" guidedModeOnly={true} isHomeGuide={true} />
              </div>
            </div>
          </Card>
