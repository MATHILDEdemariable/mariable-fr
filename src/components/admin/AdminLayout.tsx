...
const AdminLayout: React.FC<AdminLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    },
    {
      ...
      href: '/admin/devis',
      icon: FileText,
      current: location.pathname === '/admin/devis'
    },
    {
    ...
    {
      name: 'Analyse Utilisateur',
      href: '/admin/user-analysis',
      icon: Users,
      current: location.pathname === '/admin/user-analysis'
    },
    {
    ...
    {
      name: 'Demandes Paiements',
      href: '/admin/payment-leads',
      icon: FileText,
      current: location.pathname === '/admin/payment-leads'
    },
    {
      name: 'Blog',
      href: '/admin/blog',
