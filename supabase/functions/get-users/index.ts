    ...
    try {
      ...
      try {
        const { data: profileUsers, error: profileError } = await supabase
          .from('profiles')
          .select('id, first_name, last_name, account_type, subscription_type, subscription_expires_at, wedding_date, guest_count, created_at, notify_club_mariable, registration_purpose, referral_source, preferred_language')
